...
.L80016944:
/* 17544 80016944 3C01800B */  lui        $at, %hi(gNumMemoryPools)
/* 17548 80016948 A0200A70 */  sb         $zero, %lo(gNumMemoryPools)($at)
...
/* 17568 80016968 0C005A78 */  jal        mmInitPool    # Heap 0 (no expansion)
...
/* 17588 80016988 0C005A78 */  jal        mmInitPool    # Heap 0
...
/* 175A0 800169A0 0C005A78 */  jal        mmInitPool    # Heap 1
...
/* 175B8 800169B8 0C005A78 */  jal        mmInitPool    # Heap 2
/* 175BC 800169BC 01E42823 */   subu      $a1, $t7, $a0
.L800169C0:
/* 175C0 800169C0 0C005C95 */  jal        mmSetDelay
/* 175C4 800169C4 24040002 */   addiu     $a0, $zero, 0x2
/* 175C8 800169C8 3C01800B */  lui        $at, %hi(gMemoryFreeQueueLength)
/* 175CC 800169CC A4201798 */  sh         $zero, %lo(gMemoryFreeQueueLength)($at)
